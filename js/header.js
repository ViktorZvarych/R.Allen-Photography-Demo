...
(() => {
  ...
  /*COUNT OF KILLED INVADERS  -  FETCH*/
  async function showCountOfKilledOrks() {
    ...
    countOfKilledOrks.innerHTML =
      numberOfKilledOrks +
      ' invaders have been killed <span style="font-size: 0.7rem; color: antiquewhite;">    // fetch</span>';
  }
  showCountOfKilledOrks();

  /*INCREASE OF KILLED INVADERS  -  XMLHttpRequest*/
  ...
  function showIncreaseOfKilledOrks(error, statsOfWar) {
    if (error) {
      ...
      increaseOfKilledOrks.innerHTML =
        ...
        ' invaders were killed yesterday <span style="font-size: 0.7rem; color: antiquewhite;">    // XMLHttpRequest</span>';
    }
  }
