(() => {
  const slides = [
    '<div><img src="img/girl_hides_from_sun.webp" alt="Girl hides from the sun"></div>',
    '<div><img src="img/girl_in_a_half_turn.webp" alt="A girl in a half turn"></div>',
    '<div><img src="img/beautiful_girl_in_jacket.webp" alt="Beatiful girl in a jacket"></div>',
  ];
